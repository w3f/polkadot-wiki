---
id: lang-chinese-build-build-with-polkadot
title: Polkadot開發者快速入门指南
sidebar_label: Polkadot開發者快速入门指南
---
...
TODO:![build 1](../assets/build-1.png)
...
TODO:![build 2](../assets/build-2.png)
...
TODO:将来也会有很多Polkadot runtime的[实现](../../../polkadot/learn/implementations.md)在各种语言包括C ++，Rust，Go和JS。
...
TODO:[Cumulus](../../../polkadot/build/cumulus.md)的目标是成为Substrate的扩展，它将会使所有Substrate runtime兼容于Polkadot。
...
TODO:平行链位置将会通过公开拍卖出售，其机制可以在[平行链拍卖](../../../polkadot/learn/auction.md)维基页面上找到。
