...
Узлы, которые мониторят в сети валидаторов или коллаторов, которые ведут себя плохо. Рыбаки должны застейкать небольшое количество DOT, но могут быть щедро вознаграждены, если обнаружат плохое поведение.
...
## Номинированное доказательство доли владения (NPoS)
...
## Голосование через референдуме (Tabling)
