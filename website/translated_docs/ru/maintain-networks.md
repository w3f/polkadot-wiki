...
To connect to a Substrate public network first follow the [instructions](https://substrate.dev/docs/en/overview/getting-started#fast-installation) for installing the Substrate executable.
