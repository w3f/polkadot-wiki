...
Account balance information is stored in [`AccountData`](https://substrate.dev/rustdocs/v3.0.0/pallet_balances/struct.AccountData.html). Polkadot primarily deals with two types of balances: free and reserved.
...
- [Lockable Currency](https://substrate.dev/rustdocs/v3.0.0/frame_support/traits/trait.LockableCurrency.html)
- [Lock Withdraw Reasons](https://substrate.dev/rustdocs/v3.0.0/frame_support/traits/enum.WithdrawReason.html)
- [Vesting](https://substrate.dev/rustdocs/v3.0.0/pallet_vesting/struct.Vesting.html)
