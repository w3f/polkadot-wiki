...
{{ kusama: the [Kusama Direction room](https://app.element.io/#/room/#kusama:matrix.parity.io) or the [Kusama Watercooler](https://app.element.io/#/room/#kusamawatercooler:polkadot.builders) :kusama }}.
...
{{ kusama: [polkassembly](https://kusama.polkassembly.io) :kusama }} that explains her reasoning for why Bob deserves the tip.
