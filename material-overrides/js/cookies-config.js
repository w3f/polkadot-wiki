window.addEventListener("load", function () {
  window.cookieconsent.initialise({
    ...
    content: {
      ...
      href: "/policies/legal-disclosures",
    },
  ...
  function loadKapaWidget() {
    ...
    script.setAttribute('data-modal-disclaimer', `This is an AI chatbot trained to answer questions about Polkadot. As such, the answers it provides might not always be accurate or up-to-date. Please use your best judgement when evaluating its responses. Also, **please refrain from sharing any personal or private information with the bot**. By submitting a query, you agree that you have read and understood [these conditions](/policies/legal-disclosures).
