...
you may do so by clicking on the network selection at the top left hand corner of the navigation
...
To send a transfer between parachains, navigate to "Accounts" > "Transfer".
