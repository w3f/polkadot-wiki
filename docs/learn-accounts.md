...
account does not exist yet on-chain. For that, it needs the existential deposit: 0.001666666667 KSM (on
Kusama) or 0.01 DOT (old) / 1 _New DOT_ (on Polkadot mainnet) .
