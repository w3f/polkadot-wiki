...
As of Runtime 28, the default [address format](../../reference/accounts-advanced.md#address-format) is the [`MultiAddress`](https://github.com/paritytech/polkadot-sdk/blob/master/substrate/primitives/runtime/src/multiaddress.rs)
type.
...
### Account Derivation on [Ledger](../../learn/learn-guides-ledger.md) Live
...
[the accounts page](../getting-started/accounts/index.md) for more information about derived accounts and
derivation paths.

Note that you cannot import Kusama Ledger accounts in Ledger Live. To see Kusama account balances,
you must import your ledger account into a non-custodial wallet.

### Account Derivation on [Subkey](#creating-accounts-with-subkey) and [Polkadot Vault](../../learn/learn-guides-vault.md)
