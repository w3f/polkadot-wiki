...
A blockchain [bridge](../knowledge-base/glossary.md#bridge) is a connection that allows for arbitrary data
...
[Validators](../knowledge-base/glossary.md#validator), if elected to the validator set, produce blocks on
...
[Nominators](../knowledge-base/glossary.md#nominator) bond their stake to particular validators in order to
...
[Collators](../knowledge-base/glossary.md#collator) are full nodes on both a parachain and the relay chain.
