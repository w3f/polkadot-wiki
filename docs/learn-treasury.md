...
The proposer has to deposit 5% of the requested amount or 100 DOT / 3.3 KSM (whichever is higher) as
an anti-spam measure. This amount is burned if the proposal is rejected, or refunded otherwise.
These values are subject to [governance](learn-governance) so they may change in the future.
...
values: 3.3 KSM or 5% of the requested amount.
...
the goal of fixing a bug, vulnerability, develop a strategy, or monitoring a set of tasks related to
a specific topic: all for the benefit of the Polkadot ecosystem.
...
maliciously. But if they are successful in their task of getting someone to complete the bounty
...
- [Substrate's Treasury Pallet](https://github.com/paritytech/substrate/blob/master/frame/treasury/src/lib.rs) -
  ...
  ([Docs](https://substrate.dev/rustdocs/v2.0.1/pallet_treasury/index.html))
