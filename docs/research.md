...
The Polkadot [research pages](https://w3f-research.readthedocs.io/en/latest/polkadot/overview.html) are edited directly by the
researchers at W3F and contain papers, articles, and documents that are sources for the information on the wiki.
