...
BABE requires keys suitable for use in a [Verifiable Random Function](../randomness#vrfs) as well as for digital signatures. Sr25519 keys have both capabilities and so are used for BABE.
