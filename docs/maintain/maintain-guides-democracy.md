...
[Polkadot Direction](https://matrix.to/#/#polkadot-direction:matrix.parity.io) -  a place to discuss governance and the future of Polkadot.
[Kusama Direction](https://matrix.to/#/#kusama:matrix.parity.io) -  a place to discuss governance and the future of Kusama.

[Polkadot](https://matrix.to/#/#kusama:matrix.parity.io) and [Kusama](https://matrix.to/#/#kusama:matrix.parity.io) Polkassembly - for current referenda, latest proposals, motions, treasury proposals, tips, bounties and more.

[Polkadot Daily Digest](https://matrix.to/#/#dailydigest:web3.foundation) - News about what is happening in the Polkadot ecosystem, published every weekday except holidays
