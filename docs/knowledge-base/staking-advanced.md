...
If you want to become a nominator, see [this](../getting-started/staking/roles.md) guide. If you are a
...
found [here](../../reference/accounts-advanced.md#derivation-paths).
