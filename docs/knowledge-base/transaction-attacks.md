...
A replay attack is where past transactions can be replayed (same [balance](transactions.md#balance-transfers),
...
[reaping accounts](../getting-started/accounts/index.md#existential-deposit-and-reaping) because the reaping
...
Making a [transaction mortal](transactions.md#mortal-and-immortal-extrinsics) with a
