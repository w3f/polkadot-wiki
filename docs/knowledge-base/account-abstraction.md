...
institution. In [Web3](../getting-started/web3.md), you digitally sign any transaction or, more
...
Adopting a generic design is crucial in scaling [Web3](../getting-started/web3.md)
...
specific function within a particular [pallet](glossary.md#pallet).
...
In [Substrate](glossary.md#substrate)'s FRAME, functions are not necessarily called by
...
- [Multi-signature accounts](../../knowledge-base/multisig.md) to control an account using different ones
- [Proxy accounts](../../knowledge-base/proxies.md) for role-based representation, and ownership representation
  through [pure proxies](../../knowledge-base/proxies.md)
- [Derivative accounts](../../reference/accounts-advanced.md#derivation-paths) for using the same _parent_
...
example using Wasm-based smart contract languages.

## Further Readings

- [Hackernoon Article](https://hackernoon.com/abstracting-away-account-abstraction-on-polkadot) by
  [Bader Youssef](contributors.md#bader-youssef) - "Abstracting Away Account Abstraction
  on Polkadot"
