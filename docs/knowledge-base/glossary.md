...
delegators can be [slashed](offenses.md). Polkadot uses the Phragmén method to
...
[Polkadot OpenGov](opengov.md) serves as the current governance protocol for
...
or incompetently. For more information, see the [page about offenses](offenses.md).
...
[Asset Hub](asset-hub.md), [Bridge Hub](system-chains.md#bridge-hub),
[Collectives](system-chains.md#collectives) and
[People Chain](system-chains.md#people-chain).
...
with a [Track](../getting-started/governance/mechanics.md#origins-and-tracks-info). The Track outlines
...
[Web3 ecosystem](../getting-started/web3.md).
...
protocol-level features like [asynchronous backing](../reference/async-backing.md), etc, that are
