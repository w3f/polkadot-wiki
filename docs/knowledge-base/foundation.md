...
- **Treasury proposals & Bounties:** they make up the largest share of outflow tokens to the
  ...
  [spend period](glossary.md#spend-period).
- **Tips:** smaller payouts directly to grantees that can happen within a
  [spend period](glossary.md#spend-period).

!!!info "Spend Period Schedule"
    On Polkadot-JS UI, navigate to Governance > Treasury to view the status of current [spend period](glossary.md#spend-period).
...
[multi-signature account](../../knowledge-base/multisig.md). Bounties can access a large amount of funds,
