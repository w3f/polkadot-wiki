...
| Other | [open-web3 JS library](https://github.com/open-web3-stack/open-web3.js) 🟡, [VM-Bridge](https://github.com/CycanTech/GVM-Bridge) 🔴, [srtool](https://github.com/paritytech/srtool) 🟡, [Substrate Tip Bot](https://github.com/paritytech/substrate-tip-bot) 🟡, [ORI (Onchain Risk Intelligence)](https://github.com/syntifi/ori) 🔴, [PolkaTools](https://github.com/albertov19/PolkaTools) 🟢, [polkadot-scripts](https://github.com/paritytech/polkadot-scripts) 🟢, [Static analyzer for Substrate FRAME's pallets](https://github.com/simon-perriard/saft) 🟡, [Sube](https://github.com/virto-network/sube) 🔴, [data-store-sidecar](https://github.com/CESSProject/data-store-sidecar) 🟡, [SugarFunge](https://github.com/SugarFunge/sugarfunge-node) 🟡
...
| Privacy | [Slushie mixer](https://github.com/4IRE-Labs/Slushie) 🟢
