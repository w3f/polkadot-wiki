...
Subsquid replaces direct gRPC node access with perfomant super-archive gateways, allowing quick synchronization of the API with the historical on-chain data.  
