...
The results are further optimized to more evenly distribute the load (which is a desirable feature,
as discussed below) via post-processing.
...
as high as possible. For example, imagine a result of five validators being elected, where
...
[Rust implementation in Substrate](https://github.com/paritytech/substrate/blob/master/frame/elections-phragmen/src/lib.rs)
