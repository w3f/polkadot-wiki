...
process applies to any other [Substrate](https://substrate.dev/docs/en/knowledgebase/learn-substrate)-based chain.
...
Follow instructions as outlined [here](https://substrate.dev/docs/en/knowledgebase/getting-started) - note that
