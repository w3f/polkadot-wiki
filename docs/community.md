...
- [Polkadot Digest](https://matrix.to/#/!vMpYyTkvjXcevxSdsQ:web3.foundation?via=web3.foundation&via=matrix.org&via=matrix.parity.io) -
  News about what is happening in the Polkadot ecosystem, published every weekday except holidays
