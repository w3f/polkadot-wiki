...
we see that the pallet at index 5 is [Balances](https://github.com/paritytech/polkadot/blob/master/runtime/polkadot/src/lib.rs#L981). Now we will check the Balances pallet's code which
...
error that we got is [InsufficientBalance](https://github.com/paritytech/substrate/blob/master/frame/balances/src/lib.rs#L402) or in other words "Balance too low to send value".
