...
transfer funds, edit identity details, etc. [Keeping your private key secure](../knowledge-base/scams.md) is
...
of your keys) there are [account abstraction](../knowledge-base/account-abstraction.md) solutions that
...
that are not exposed to the internet (see [Ledger](../learn/learn-guides-ledger.md)), or dedicated applications that can
be installed on air-gapped devices such as phones (see [Polkadot Vault](../learn/learn-guides-vault.md)). For
...
responsible for the information on your account. Transferring an [NFT](../knowledge-base/nfts.md) between
...
expensive and attempting them can get you [slashed](../knowledge-base/offenses.md).
...
[Blockspace](../knowledge-base/glossary.md#blockspace) is limited and valuable. Not all data we have can be stored on
...
[election algorithm](staking/npos.md) makes sure that the stake is maximized across all
...
[DOT is inflationary](../knowledge-base/staking-polkadot.md#dot-inflation). Inflation is used to pay validators for running
nodes and reward nominators for providing the necessary stake to secure the network.

### Governance and Treasury

In Polkadot, an on-chain [treasury](../knowledge-base/foundation.md) together with an
[open governance](../knowledge-base/opengov.md) model allow to access funds in a fully
...
interoperability through [XCM](../learn/learn-xcm.md) and [XCMP](../reference/xcm-transport.md) to
all blockchains attached to it. For more information, see the [Polkadot 1.0 page](../general/polkadot-v1.md)
and
[the section about XCM and Accords in Polkadot Direction page](../general/polkadot-direction.md#xcm-and-accords).