...
!!!tip "New to Staking?"
    Start your staking journey or explore more information about staking on [Polkadot's Home Page](https://polkadot.network/staking/). You can learn how staking works by reading [this dedicated page](../../knowledge-base/staking-advanced.md).
...
[keys section](../../reference/cryptography.md#keys).
...
[![Staking Tutorial](../../assets/0.jpg)](https://www.youtube.com/watch?v=F59N3YKYCRs)
