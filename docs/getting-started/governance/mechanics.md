...
!!!info "Learn more about Polkadot OpenGov"
    For background information about Polkadot OpenGov, please refer to this [dedicated Wiki document](../../knowledge-base/opengov.md).
...
=== "Polkadot"
    ...
    Origin commanded by the [Fellowship](../../knowledge-base/technical-fellowship.md) whitelist some
...
change to the network through an [on-chain remark](../../knowledge-base/glossary.md#remarks). This track was
