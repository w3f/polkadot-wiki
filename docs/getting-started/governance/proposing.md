...
The example below shows how to create a [preimage](../../knowledge-base/glossary.md#preimage) for a
...
[Asset Hub](../../knowledge-base/glossary.md#asset-hub).

### Creating a Preimage

The example below shows how to create a [preimage](../../knowledge-base/glossary.md#preimage) for a transaction
