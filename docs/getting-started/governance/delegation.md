...
description: Participate in Polkadot governance by delegating your voting power to community leaders.
---
...
-   **You keep your DOT**: Delegation does *not* transfer your tokens. You still hold them in your wallet.
-   **Revocable**: You can undelegate or change your delegate at any time.
-   **Granular**: You can delegate different "Tracks" to different people. For example, delegate "Treasurer" tracks to a financial expert and "Root" tracks to a technical expert.
-   **Override**: If you disagree with your delegate on a specific vote, you can vote yourself, and your vote will override theirs.
...
!!!info "Support Guide: How to Delegate"
    [**Polkadot OpenGov: Delegating Voting Power**](https://support.polkadot.network/support/solutions/articles/65000184120-polkadot-opengov-how-to-vote)

## Next Step
Keep track of what's happening with [Tracking Governance Activity](tracking.md).
