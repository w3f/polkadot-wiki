...
!!!warning "The identity pallet is no longer on the Kusama relay chain."
    ...
    The identity pallet, along with all of its data, has been migrated to the [People Chain](../../knowledge-base/glossary.md#people-chain), a system parachain which can now be used for identity management.
...
[OpenGov](../governance/voting.md), then wait for people to vote on it. For best
