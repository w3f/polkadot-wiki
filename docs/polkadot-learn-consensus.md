...
BABE assigns block production slots to validators according to stake and using the Polkadot [randomness cycle](polkadot-learn-randomness).
...
Please see the [relevant section](polkadot-learn-comparisons-cosmos#consensus) in the Cosmos comparison article.
