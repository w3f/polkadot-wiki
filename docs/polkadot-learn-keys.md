...
BABE requires keys suitable for use in a [Verifiable Random Function](polkadot-learn-randomness#vrfs) as well as for digital signatures. Sr25519 keys have both capabilities and so are used for BABE.
