...
- **Burned tokens:** at the end of each spend period,
  [a fraction](../general/constants-variables.md#treasury-burn-factor) of the available funds are
  burned.
...
pay an upfront [deposit](../general/constants-variables.md#bounty-curator-deposit) to take the
...
The bounty has a [predetermined duration](../general/constants-variables.md#bounty-duration), with
