...
See [this page](./learn-nomination-pool-lifecycle.md) for more information about the lifecycle of
nomination pools. The cycle includes creation, upkeep and destruction.
