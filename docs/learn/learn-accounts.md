...
[Substrate SS58 documentation](https://docs.substrate.io/v3/advanced/ss58/). Never use regular
...
A typical mnemonic phrase generated by [the Subkey tool](https://docs.substrate.io/v3/tools/subkey/)
is shown below.
...
See the [Subkey documentation](https://docs.substrate.io/v3/tools/subkey/) for details and examples
...
[Subkey documentation](https://docs.substrate.io/v3/tools/subkey/). When used properly, Subkey is
...
If slots 0-2 are populated by addresses A, B, and C, respectively, and I add an existential deposit
to address X, that address will automatically be put into slot 3. Henceforth, you can send me money
by just sending to `[3]` rather than remembering my complete address.
...
another address was using before.
...
The Subkey Tool's The [Inspecting Keys](https://docs.substrate.io/v3/tools/subkey/#inspecting-keys)
