...
[Substrate SS58 documentation](https://docs.substrate.io/v3/advanced/ss58/). Never use regular expressions for address validation.
...
[the Subkey tool](https://docs.substrate.io/v3/tools/subkey/) is shown below.
...
See the [Subkey documentation](https://docs.substrate.io/v3/tools/subkey/) for
...
[Subkey documentation](https://docs.substrate.io/v3/tools/subkey/). When used
...
[Inspecting Keys](https://docs.substrate.io/v3/tools/subkey/#inspecting-keys)
