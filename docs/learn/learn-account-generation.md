...
See [**this video tutorial**](https://youtu.be/9ohp8k4Hz8c) to learn how to change the password for an account that has been created on the Polkadot-JS browser extension (i.e. an injected account).
...
See [**this video tutorial**](https://youtu.be/cBsZqFpBANY) to learn how to change the password for an account that has been created on the Polkadot-JS UI (i.e. a non-injected account).
