...
is required to submit an intention to nominate. Note that in NPoS the stake of both nominators and
...
this case, the slash is proportionate to the amount staked to that specific validator. Note that you
