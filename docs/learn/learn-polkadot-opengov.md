...
and an account A with 10 {{ polkadot: DOT :polkadot }}{{ kusama: KSM :kusama }} votes "Aye" with 4x conviction, whereas account B votes "Nay" with 5 {{ polkadot: DOT :polkadot }}{{ kusama: KSM :kusama }} with 2x conviction 
