...
- group participation in governance: a multisig account can do everything a regular account can. A
  multisig account could be a council member in \{\{ polkadot: Polkadot's :polkadot }}\{\{ kusama:
  Kusama's :kusama }} governance, where a set of community members could vote as one entity.
