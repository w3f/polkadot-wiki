...
!!! warning "IMPORTANT"
    ...
    In this article you will learn how to create a new account in Subkey, which is meant for **advanced users**. If you want to know how to create an account **in the Polkadot Developer Signer** , please refer to [this article](create-polkadot-account.md).
...
2\. Next, open a terminal (Mac) or PowerShell (Windows) and enter the following two commands to install the dependencies and Subkey. The official guide is [here.](https://github.com/paritytech/polkadot-sdk/tree/master/substrate/bin/utils/subkey)
...
This is your new account. Make sure to [save your 12-word mnemonic phrase safely](store-mnemonic-safely.md). For more Subkey commands, please refer to [this guide](https://github.com/paritytech/polkadot-sdk/tree/master/substrate/bin/utils/subkey).
