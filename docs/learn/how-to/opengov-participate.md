...
description: "Polkadot OpenGov allows you to decide on protocol changes and manage its Treasury. Thanks to Subsquare, this is easy and user-friendly. Learn here how to do it."
---
