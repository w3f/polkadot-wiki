...
!!! warning "IMPORTANT"
    ...
    If you are staking on Kusama, the Staking Dashboard will not recognize the Polkadot Migration app. It's recommended that you connect your Ledger to a [compatible wallet](https://paritytech.github.io/polkadot-support/trending/top-articles/where-to-store-dot-polkadot-wallet-options), unbond, and transfer your KSM to the account generated by the Generic Polkadot Ledger app. Remember that the Polkadot Ledger app can now operate on Kusama as well!
...
!!! info
    ...
    Check some of the wallets you can use with the Staking Dashboard in the article "[Where to Store DOT: Polkadot Wallet Options](https://paritytech.github.io/polkadot-support/trending/top-articles/where-to-store-dot-polkadot-wallet-options)"
...
!!! warning "ATTENTION"
    ...
    It is recommended to set your stash account as its own controller (learn how to do it [here](https://paritytech.github.io/polkadot-support/staking/staking-basics/staking-dashboard-how-to-update-your-controller-account)) and create a staking proxy to obtain the same benefits and greater flexibility.
