...
| Referenda executed from one origin (Root).                                                                                                                                                                                                                                                                                                    | Referenda executed from [multiple origins](../maintain/maintain-guides-opengov.md#origins-and-tracks-info), each having a different track that shapes proposals' timeline. Depending on the origin, multiple copies of the same track are possible. | Possibility to categorize proposals (based on importance and urgency) and execute them simultaneously within and between origins.                           |
