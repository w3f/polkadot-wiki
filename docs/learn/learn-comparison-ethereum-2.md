...
and can send messages via their established channels. Given that collators will also need to be full
nodes of the Relay Chain, they will be connected. They can relay messages from
