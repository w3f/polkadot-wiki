...
than the relay chain. Rather than purchasing time an execution core, execution cores are allocated
by network [governance](./learn-guides-polkadot-opengov.md).
