...
Governance v1 is deprecated. To access \{\{ polkadot: Polkadot :polkadot }}\{\{ kusama: Kusama
:kusama }} treasury funds use [OpenGov](./learn-polkadot-opengov.md). For more information about
OpenGov Treasury see the [dedicated wiki page](./learn-polkadot-opengov-treasury.md).
...
\{\{ polkadot: Polkadot :polkadot }}\{\{ kusama: Kusama :kusama }}. Charlie tips \{\{ polkadot: 10
DOT :polkadot }}\{\{ kusama: 1 KSM :kusama }}, Dave tips \{\{ polkadot: 30 DOT :polkadot }}\{\{
kusama: 3 KSM :kusama }}, and Eve tips \{\{ polkadot: 100 DOT :polkadot }}\{\{ kusama: 10 KSM
:kusama }}.
...
\{\{ polkadot: 30 DOT :polkadot }}\{\{ kusama: 3 KSM :kusama }} from the Treasury. In order for Bob
to be paid his tip, some account must call the `close_tip` extrinsic at the end of the closing
period for the tip. This extrinsic may be called by anyone.
...
related to a specific topic: all for the benefit of the \{\{ polkadot: Polkadot :polkadot }}\{\{
kusama: Kusama :kusama }} ecosystem.
