...
decentralized proof-of-stake blockchains like \{\{ polkadot: Polkadot :polkadot }}\{\{ kusama:
Kusama :kusama }} such attacks are financially expensive, and attempting to do it can get you
...
impact a considerable fraction of the nodes and potentially stop the network. \{\{ polkadot: Pokadot
:polkadot }}\{\{ kusama: Kusama :kusama }} level of decentralization can be explored through the
[Polkawatch app](https://polkawatch.app/).
...
attack to happen is equally difficult across all nodes. \{\{ polkadot: Polkadot :polkadot }}\{\{
kusama: Kusama :kusama }}'s [election algorithm](../learn/learn-phragmen.md) makes sure that the
stake is maximized across all active validators, and the variance in stake across validators is
