...
<div id="messageBox" class="floating-message-box">
  <p>
    ...
    If you need help using the Polkadot Developer Interface, you can contact the
...
!!!info
    We support only the use of the [**Polkadot Developer Interface**](https://polkadot.js.org/apps/#/explorer) together with the [**Polkadot Developer Signer**](https://polkadot.js.org/extension/), [**Ledger**](https://www.ledger.com/ledger-live) and [**Polkadot Vault**](https://www.parity.io/technologies/signer/) for signing transactions. We do not provide support for third party applications.
...
- [The Polkadot Developer Interface](#polkadot-developer-interface)
- [The Polkadot Developer Signer](#polkadot-developer-signer)
...
The Polkadot Developer Interface is an application that loads in your browser. There is a standard DNS
...
always refer to Polkadot Developer Interface.
...
### Polkadot Developer Interface Desktop App

The Polkadot Developer Interface also exists as a
...
Let's see how we can query on-chain data with Polkadot Developer Interface on the Polkadot network with an
...
The [**Polkadot Developer Signer**](https://polkadot.js.org/extension/) is not a wallet _per se_
...
extension-compliant dApps such as the [**Polkadot Developer Interface**](https://polkadot.js.org/apps/#/explorer)
and the [**Polkadot Staking Dashboard**](https://staking.polkadot.cloud/#/overview).

!!!info Metadata Updates
    The browser extension is a tool that interacts with the Polkadot network, but it is disconnected from it when it is not in use. It is important you [**always check for metadata updates**](../learn/learn-guides-accounts.md#polkadot-developer-signer) before using the extension or other account management tools such as Parity Signer (aka Polkadot Vault).

## Polkadot-JS Phishing List

The [**Polkadot-JS phishing list**](https://polkadot.js.org/phishing/) website is a community-driven
curation of malicious actors and operators. The Polkadot Developer Signer uses this list to warn a user
