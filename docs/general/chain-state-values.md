...
=== "Polkadot"
    ...
    !!!info "What to do with DOT"
        - __{{ rpc("polkadot-assethub", "Balances", "ExistentialDeposit", 0, is_constant=true, readable="human_readable") }} :__ the minimum balance required to have an active account on Polkadot Network. If your account balance drops below the minimum, your account will be reaped. Learn more about [Accounts](../getting-started/accounts/index.md) and the [Existential Deposit](../getting-started/accounts/index.md#existential-deposit-and-reaping) requirement.
        - __{{ rpc("polkadot-assethub", "NominationPools", "MinJoinBond", 0, is_constant=false, readable="human_readable") }} :__ the minimum contribution required to join a [nomination pool](../knowledge-base/nomination-pools.md) and earn staking rewards for contributing to the security of the network. Learn more about [nomination pools](../knowledge-base/nomination-pools.md).
        - __{{ rpc("polkadot-people", "Identity", "BasicDeposit", 0, is_constant=true, readable="human_readable") }} :__ register an [on-chain identity](../knowledge-base/identity.md)
        - __{{ rpc("polkadot-assethub", "Proxy", "ProxyDepositBase", 0, is_constant=true, readable="human_readable") }} :__ create a [proxy account](../knowledge-base/proxies.md).
        ...
        - __{{ rpc("polkadot-assethub", "Staking", "MinimumActiveStake", 0, is_constant=false, readable="human_readable") }} :__ the minimum amount of DOT required to become an active nominator and earn rewards, i.e. the minimum active bond. To increase the chance of earning staking rewards, your stake should not be less than the minimum stake among the active nominators, which is a dynamic threshold. If you have lesser DOT than the minimum active nomination, please consider contributing to [nomination pools](../knowledge-base/nomination-pools.md). Learn more about [becoming a nominator](../getting-started/staking/roles.md).
        - __{{ rpc("polkadot-assethub", "NominationPools", "MinCreateBond", 0, is_constant=false, readable="human_readable") }} :__ you can create your own [nomination pool](../knowledge-base/nomination-pools.md).
...
=== "Kusama"
    ...
    !!!info "What to do with KSM"
        ...
        - __{{ rpc("kusama-assethub", "NominationPools", "MinJoinBond", 0, is_constant=false, readable="precise_ksm") }} :__ the minimum contribution required to join a [nomination pool](../knowledge-base/nomination-pools.md) and earn staking rewards for contributing to the security of the network. Learn more about [nomination pools](../knowledge-base/nomination-pools.md).
        - __{{ rpc("kusama-people", "Identity", "BasicDeposit", 0, is_constant=true, readable="precise_ksm") }} :__ register an [on-chain identity](../knowledge-base/identity.md)
        - __{{ rpc("kusama-assethub", "Proxy", "ProxyDepositBase", 0, is_constant=true, readable="human_readable_kusama") }} :__ create a [proxy account](../knowledge-base/proxies.md).
        ...
        - __{{ rpc("kusama-assethub", "Staking", "MinimumActiveStake", 0, is_constant=false, readable="human_readable_kusama") }} :__ the minimum amount required to become an active nominator and earn rewards, i.e. the minimum active bond. To increase the chance of earning staking rewards, your stake should not be less than the minimum stake among the active nominators, which is a dynamic threshold. If you have lesser KSM than the minimum active nomination, please consider contributing to [nomination pools](../knowledge-base/nomination-pools.md). Learn more about [becoming a nominator](../getting-started/staking/roles.md).
        - __{{ rpc("kusama-assethub", "NominationPools", "MinCreateBond", 0, is_constant=false, readable="human_readable_kusama") }} :__ you can create your own [nomination pool](../knowledge-base/nomination-pools.md).
