...
Join the global Web3 movement – be among the first to try out innovative dapps running on Polkadot. You can
browse the list of dApps on [the official Polkadot website](https://polkadot.network/ecosystem/dapps/). This page
also features a form that can be submitted to showcase dApps that are not already listed.

:::

:::info Community Page

It is recommended to have the parachain apps added to [the official Polkadot website](https://polkadot.network/ecosystem/dapps/) 
and then use this page to elaborate their key features to the Pokadot Wiki readers.
