...
<tr class="cards-container">
  <td>
    <a class="guide-link" href="../docs/learn-crowdloans/">
...
Kusama is a permissionless network and anyone can come along and start using it. Those who participated in the Polkadot sale can claim a proportional amount of KSM through the
...
Hone your [validator set-up][validator setup]. The minimum requirement for staking as a
validator on Kusama is lower than it is for Polkadot. There are also programs
in place such as [Thousand Validators][thousand validators] to help community validators rise
the ranks. This includes participating in a parachain slot auction and composable applications.
...
[validator setup]: ../maintain/kusama/maintain-guides-how-to-validate-kusama
