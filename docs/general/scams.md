...
you have been the target of such an attempt or are currently being targeted, please get in contact
with [Polkadot Support](https://support.polkadot.network).

## DISCLAIMER: Key Security

One of the most attractive targets for any malicious actor are your wallet secret seeds or the
...
3. Do not trust anyone online. Malicious actors often pretend to be someone else in order to gain
   your trust.
4. [If you are scammed](#i-got-scammed---what-can-i-do), there is likely **nothing that can be
   ...
   of your funds to their account in seconds.
...
6. Scams are absolutely rife in this space. It is easy and cheap to set a scam up, and hard to shut
   one down. Therefore,it is the users duty to be as diligent as possible in order to avoid such
   scams.
7. If you can, always try to verify new information that you see through an official source, such as
   ...
   websites or a blog posts, but if you validate such information through a secondary source you
   will reduce the chances of being scammed.
...
- People offering to help you to stake or to get rewards.
...
`jo_smith` instead of `joe_smith`. Sometimes the display name will be identical if uniqueness is not
enforced, check over a 2nd (ideally verifiable) communication channel to be sure you are talking to
the right person.
...
"rewards", or message you privately to help with a problem you posted publicly. Our social media and
community pages can be found [here](./community.md).
...
- DO NOT keep your seed phrase on any electronic medium that is connected to the internet, e.g cloud
  services, password managers, on your daily computer, etc.
...
- Keep your computer free of malware. Although an antivirus can be of great help, it's not a
  ...
  of unvetted (not security-scanned) software such as extensions, 3rd party software
