...
languages as possible. Another way you can contribute is by helping with translations.
...
The following shows an example in _Arabic_. You can type in your desired translation for each
