...
Starting in February 2024, Web3 Foundation plans to share a new application form for the community
validators that will include a KYC and KYB process. Until then, all the applications submitted will
