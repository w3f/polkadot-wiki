...
stakers and part to the [treasury](../knowledge-base/foundation.md).
...
[Nominated Proof of Stake (NPoS)](../reference/consensus.md#nominated-proof-of-stake) and to grow the
...
[on-chain governance](../knowledge-base/opengov.md)** based on thorough tokenomics research.
...
[this page](../knowledge-base/foundation.md) for more information about treasury inflow
sources.
...
[system parachains](../knowledge-base/system-chains.md), there are 45 auctioned cores. The
