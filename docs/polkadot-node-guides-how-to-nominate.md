---
id: polkadot-node-guides-how-to-nominate
...
We will assume that you will be starting with two fresh accounts. Click [here](polkadot-learn-staking#accounts) to learn more about what `stash` and `controller` accounts mean.
...
- **Payment destination** - where the rewards get sent. More info [here](polkadot-learn-staking#reward-distribution).
