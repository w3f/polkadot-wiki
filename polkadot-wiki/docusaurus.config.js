  ...
  themeConfig: {
    ...
    */
    ...
    announcementBar: {
      id: "banner",
      content:
        'Registration for Polkadot Decoded 2023 is now open! Join Polkadot’s flagship conference on June 28-29. <a href="<https://polkadot.network/ecosystem/events/decoded-2023/?utm_source=wiki.polkadot.network&utm_medium=referral&utm_campaign=decoded23&utm_content=notification>" target="_blank" rel="noopener nofollow noreferrer">Learn more 👉</a>',
      backgroundColor: '#e6007a',
      textColor: 'white',
      isCloseable: true,
    },
