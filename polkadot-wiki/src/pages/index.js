    ...
    <NavContainer>
      <NavItem href={useDocUrl("getting-started")} aosDelay="0">
        ...
        <NavItemContent>
          ...
          >
            Polkadot is a sharded protocol that enables blockchain networks to
  ...
  const LearnKusama = () => (
    <Col lg={6}>
      ...
      <p className="">
        ...
        >
          Kusama is Polkadot’s “canary network”, a scalable, multi-chain network
          for radical innovation and early stage Polkadot deployments. For
          developers, Kusama is a proving ground for all things Polkadot I.e
    ...
    <Col lg={6}>
      ...
      <p className="">
        ...
        >
          ...
          of knowledge on Polkadot and the Polkadot ecosystem.
        </Translate>
      </p>
      <div>
